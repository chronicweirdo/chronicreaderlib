var Rar = (function (exports) {
    ...
    class BlobReader extends Reader {
        ...
        open() {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                return this.blob.arrayBuffer().then((ab) => {
                    this.arrayBuffer = ab
                })
            })
        }
        ...
        read(length, position) {
            return __awaiter(this, void 0, void 0, function* () {
                /*var brr = [];
                for (var i=position; i<length; i+=3) brr.push(this.byteArray[i])
                return brr*/
                ...
                /*return this.blob.arrayBuffer().then((ab) => {
                    console.log(ab)
                    return ab.slice(position, position+length)
                })*/

                return this.arrayBuffer.slice(position, position+length)
            });
        }
    }
    ...
    function fromBlob(blob) {
        return __awaiter(this, void 0, void 0, function* () {
            return fromReader(new BlobReader(blob));
        });
    }
